...
blocks:
  ...
  - imagePosition: Right
    image:
      src: /uploads/space-llama-tinacms.jpg
      alt: Space Llama
    body: >
      ### The CMS Frontend


      TinaCMS provides an intuitive CMS interface for your editors. For sites
      using React, TinaCMS supports "Visual Editing" to allow content editors to
      see real-time changes.


      /admin Route: Users interact with the CMS by navigating to the /admin page
      on your site.


      Saving: When users make a change in the CMS, a commit is made back to your
      Git repository.
